...
async function startServer() {
  ...
  let packages = [
    { 
      ...
      status: "Mở bán",
      workoutSchedule: [
        { day: "Thứ 2", activity: "Ngực & Tay sau", exercises: "Đẩy ngực nằm (Flat Bench Press) 4x10, Đẩy ngực dốc lên 3x12, Kéo cáp tay sau (Tricep Pushdown) 4x12" },
        { day: "Thứ 3", activity: "Lưng xô & Tay trước", exercises: "Kéo cáp lưng rộng (Lat Pulldown) 4x10, Gập người chèo tạ đòn (Barbell Row) 4x10, Cuốn tạ đơn tay trước (Dumbbell Curl) 3x12" },
        { day: "Thứ 4", activity: "Cardio nhẹ nhàng", exercises: "Chạy bộ dốc nhẹ trên máy chạy 30-40 phút, đi bộ thả lỏng 10 phút, ép dẻo kéo giãn cơ toàn thân" },
        { day: "Thứ 5", activity: "Chân - Đùi & Cơ bụng", exercises: "Gánh đùi không tạ hoặc tạ nhẹ (Squat) 4x15, Leg Extension 3x12, Gập bụng (Crunches) 4x15, Plank tĩnh 3 lần x 60s" },
        { day: "Thứ 6", activity: "Bờ vai & Bụng", exercises: "Đẩy vai tạ đôi ngồi (Shoulder Press) 4x10, Dang tạ đôi hai bên (Lateral Raise) 4x12, Gập bụng nằm nghiêng 3x15" },
        { day: "Thứ 7", activity: "HIIT Sức bền & Core", exercises: "Chạy biến tốc (HIIT Running) 20 phút, Nhảy dây tự do 3x3 phút, Gập bụng ngược 4x15, Plank nghiêng 3x45s" },
        { day: "Chủ Nhật", activity: "Nghỉ ngơi hoàn toàn", exercises: "Thư giãn, hồi phục cơ bắp bằng massage nhẹ hoặc ngủ đủ giấc nạp năng lượng" }
      ]
    },
    { 
      id: 2, 
      ...
      status: "Mở bán",
      workoutSchedule: [
        { day: "Thứ 2", activity: "Push Day (Ngực, Vai, Tay sau)", exercises: "Incline Barbell Press 4x8, flat Dumbbell Flyes 3x12, Dumbbell Shoulder Press 4x10, Overhead Dumbbell Tricep Extension 3x12" },
        { day: "Thứ 3", activity: "Pull Day (Lưng xô, Tay trước)", exercises: "Deadlift cốt lõi 3x5, Lat Pulldown tay cầm rộng 4x10, Seated Cable Row 3x12, Barbell Bicep Curl 4x10" },
        { day: "Thứ 4", activity: "Leg Day (Mông đùi & Bắp chân)", exercises: "Barbell Squat sâu vai 4x8, Romanian Deadlift 4x10, Leg Press 3x12, Standing Calf Raises 4x15" },
        { day: "Thứ 5", activity: "Nghỉ ngơi / Yoga phục hồi", exercises: "Tập giãn cơ nhẹ nhàng, thiền hít thở sâu 15 phút, giải phóng mỏi khớp mỏi lưng" },
        { day: "Thứ 6", activity: "Upper Body (Thân trên phối hợp)", exercises: "Kéo xà đơn (Pull-ups) 3x8, Dumbbell Incline Press 4x10, Cable Rows kéo ngang 4x12, Face Pulls vai sau 3x15" },
        { day: "Thứ 7", activity: "Lower Body & Abs", exercises: "Bulgarian Split Squats tạ đơn 3x10/bên, Hanging Leg Raises chân dốc xà đơn 4x12, Ab Wheel cuộn bụng 3x10" },
        { day: "Chủ Nhật", activity: "Nghỉ ngơi tái tạo", exercises: "Tránh vận động nặng, uống nhiều nước và ăn nhiều rau xanh giàu vitamin" }
      ]
    },
    { 
      id: 3, 
      ...
      status: "Mở bán",
      workoutSchedule: [
        { day: "Thứ 2", activity: "Upper A (Sức mạnh ngực & kéo)", exercises: "Incline Dumbbell Press 4x8, Pull-Ups 4xMax, Cable Cross-over ép ngực 3x12, Barbell Rows kéo lưng tạ đòn 4x10" },
        { day: "Thứ 3", activity: "Lower A (Sức mạnh thân dưới)", exercises: "Back Squat tạ gánh 4x6, Leg Curls đùi sau 4x12, Leg Press rộng bàn chân 3x10, Standing Calf Raises bắp chân 4x20" },
        { day: "Thứ 4", activity: "HIIT Sức bền & Core nâng cao", exercises: "Kettlebell Swing tạ ấm 4x20, Mountain Climbers chạy núi 4x30s, Russian Twists xoay bụng tạ đôi 4x20, Chạy dốc trên máy chạy 25 phút" },
        { day: "Thứ 5", activity: "Upper B (Chuyên sâu vai & cánh tay)", exercises: "Military Press đẩy tạ đứng 4x8, Hammer Curls cuốn búa tay trước 3x12, Tricep Dips nằm đẩy xà kép 3xMax, Dumbbell Lateral Raise dang vai ngang 4x15" },
        { day: "Thứ 6", activity: "Lower B (Thân chân sau đùi mông)", exercises: "Sumo Deadlift rộng chân tạ đòn 4x6, Bulgarian Split Squats chân sau 3x10, Goblet Squat ôm tạ ấm 3x12, Cable Pull-throughs kéo cáp mông 3x15" },
        { day: "Thứ 7", activity: "Kéo giãn trị liệu lý liệu", exercises: "Bơi lội sảng khoái 35-45 phút, massage giãn cơ sâu trị liệu, xông hơi hồng ngoại thải bỏ mỡ độc tố toàn thân" },
        { day: "Chủ Nhật", activity: "Nghỉ mát hồi sinh", exercises: "Chế độ dinh dưỡng hồi phục dồi dào chất xơ, đạm lành mạnh và ngủ sâu giấc" }
      ]
    },
    { 
      id: 4, 
      ...
      status: "Mở bán",
      workoutSchedule: [
        { day: "Thứ 2", activity: "PT 1:1 - Sức mạnh bốc lửa bụng vai", exercises: "Tập đẩy vai đòn tạ chuẩn chỉnh cùng Coach, Đẩy ngực phối hợp siêu chuỗi (Superset), Đi tạ bước dài mông đùi, chỉnh sửa tư thế" },
        { day: "Thứ 3", activity: "PT 1:1 - Kéo lưng xô phát triển cơ", exercises: "Kéo xà đơn bổ trợ đeo dây lựcPT, Chèo tạ lưng T-Bar chuẩn form sườn vai, Cuốn tạ cơ tay trước bọc tạ, xông hơi thảo dược" },
        { day: "Thứ 4", activity: "InBody đo chỉ số & Sức bền tim mạch", exercises: "Kiểm tra chỉ số cơ mỡ tế bào InBody định kỳ, HLV thiết kế giáo án ăn kiêng cá nhân hóa, Chạy Interval dốc cao sức khỏe tối ưu" },
        { day: "Thứ 5", activity: "PT 1:1 - Thần kinh cơ & Sửa lỗi gối vai", exercises: "Sửa lỗi gối chữ X hoặc dính khớp hông khi ngồi gánh đùi, Tập trung các bài bơi kích hoạt thần kinh cơ và thư giãn" },
        { day: "Thứ 6", activity: "PT 1:1 - Thân chân sau, mông, đùi", exercises: "Romainian Deadlift kỹ thuật hoàn hảo bảo vệ đĩa đệm lưng dưới, Lunge tạ chuỗi, Théo dẻo giãn cơ cùng PT chuyên nghiệp" },
        { day: "Thứ 7", activity: "Yoga trị liệu & Bể bơi phục hồi sâu", exercises: "Lớp Yoga VIP 1:1 điều chỉnh căng cứng cột sống cổ vai, Bơi lội sảng khoái nước ấm giải mỏi, Trị liệu cơ nâng mông xông hơi" },
        { day: "Chủ Nhật", activity: "Nghỉ ngơi tinh khiết", exercises: "Thư giãn đầu óc, sử dụng gói ngâm chân muối khoáng hồng và hồi phục năng lượng phục vụ tuần tập mới" }
      ]
    },
  ];
  ...
  app.post("/api/pos/checkout", (req, res) => {
    const { items, total, createdBy, customerName, paymentMethod } = req.body;
